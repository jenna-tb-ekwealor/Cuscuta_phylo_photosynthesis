...
stats %>%
  dplyr::mutate("Life stage" = case_when(
    file_name == "le_fvfm_seedling/output/multivariate_BM.log" ~ "1", 
    file_name == "le_fvfm_young/output/multivariate_BM.log" ~ "2", 
    file_name == "le_fvfm_old/output/multivariate_BM.log" ~ "3", 
    file_name == "le_fvfm_haustorium/output/multivariate_BM.log" ~ "4", 
    file_name == "le_fvfm_flower/output/multivariate_BM.log" ~ "5", 
    file_name == "le_fvfm_seed/output/multivariate_BM.log" ~ "6"), .before = file_name) %>% dplyr::select("Life stage", BF_correlated, BF_positive, BF_negative) -> stats

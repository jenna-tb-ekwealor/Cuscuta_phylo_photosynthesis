...
trace_quant <- RevGadgets::readTrace(path = '../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj.log')
...
# ?processAncStates()
ase <- processAncStates('../output/output_ase_rjmcmc_05/ancestral_states_cuscuta_neoxanthin_rj.tree', state_labels = c("?" = "Missing", "0" = "Neoxanthin absent","1" = "Neoxanthin present"), labels_as_numbers = FALSE)
...
pdf("../output/plots/ASE_neoxanthin_rj_pie_05event.pdf", width=6,height=3) 
# pdf("../output/plots/ASE_neoxanthin_rj_pie_05event_w_PP.pdf", width=6,height=3) 
ase_rj_pie
dev.off()
...
runs <- 1:4
for (i in runs) {
  trace_quant[i] <- RevGadgets::readTrace(path = paste0('../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_', runs[i], '.log'))
...
# check_con <- convenience::checkConvergence(list_files = c("../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_1.log", "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_1.trees", 
#                                  "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_2.log", "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_2.trees",
#                                  "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_3.log", "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_3.trees",
#                                  "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_4.log", "../output/output_ase_rjmcmc_05/cuscuta_neoxanthin_rj_run_4.trees") )
# 
